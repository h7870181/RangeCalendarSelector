...
/**
 * Created by chenpengfei88 on 2018/4/12. https://github.com/chenpengfei88/StickyItemDecoration
 */
...
public class StickyItemDecoration extends RecyclerView.ItemDecoration{
    ...
    private int getFirstVisibleItemPosition(){
        if(mLayoutManager instanceof GridLayoutManager){
            ...
            ((StaggeredGridLayoutManager) mLayoutManager).findFirstVisibleItemPositions(lastPositions);
